...
| `/code:code-style` | 用户需要检查代码风格 | 运行 lint 工具、检查代码规范 |
| `/code:code-review` | 用户需要进行代码评审 | 分析变更、识别问题、提供改进建议 |
| `/code:code-review-fix` | 用户需要修复评审问题 | 分析问题、提供修复方案、验证修复 |
